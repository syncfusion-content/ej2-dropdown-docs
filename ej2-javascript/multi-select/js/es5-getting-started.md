...
After initialization, populate the MultiSelect with data using the [dataSource](https://ej2.syncfusion.com/javascript/documentation/api/multi-select/#datasource) &nbsp;property. Here, an array of string values is passed to the MultiSelect component.
...
The height and width of the popup list can also be customized using the [popupHeight](https://ej2.syncfusion.com/javascript/documentation/api/multi-select/#popupheight) &nbsp;and [popupWidth](https://ej2.syncfusion.com/javascript/documentation/api/multi-select/#popupwidth) properties respectively.
...
* [How to bind the data](https://ej2.syncfusion.com/javascript/documentation/multi-select/data-binding)
* [How to initialize the control using different tags](https://ej2.syncfusion.com/javascript/documentation/multi-select/tags)