...
After initialization, populate the Mention with data using the [dataSource](https://helpej2.syncfusion.com/documentation/api/mention/#datasource) property. Here, an array of string values is passed to the Mention control.
...
By using the [showMentionChar](https://helpej2.syncfusion.com/documentation/api/mention/#showmentionchar) property, the text content can be displayed along with the mention character. You can customize the mention character by using the [mentionChar](https://helpej2.syncfusion.com/documentation/api/mention/#mentionchar) property in the Mention control.

> By default, the [mentionChar](https://helpej2.syncfusion.com/documentation/api/mention/#mentionchar) is `@` and the [showMentionChar](https://helpej2.syncfusion.com/documentation/api/mention/#showmentionchar) property is disabled.
