...
After initialization, populate the ListBox with data using the [`dataSource`](https://helpej2.syncfusion.com/documentation/api/list-box/#datasource) property. Here, an array of object is passed to the ListBox component.
...
* [How to reorder the items in the list box](https://helpej2.syncfusion.com/documentation/list-box/dual-list-box/#dual-list-box)
* [How to form submit to the list box](https://helpej2.syncfusion.com/documentation/list-box/how-to/form-submit/#form-submit-to-the-list-box)